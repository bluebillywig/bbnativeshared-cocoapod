...
- (void)getJsonStringAndHeadersJsonUrl:(NSString *)jsonUrl onSuccess:(void (^)(NSString *, NSDictionary<NSString *, NSArray<NSString *> *> *))onSuccess onFailure:(void (^)(BbnativesharedBoolean *))onFailure __attribute__((swift_name("getJsonStringAndHeaders(jsonUrl:onSuccess:onFailure:)")));
