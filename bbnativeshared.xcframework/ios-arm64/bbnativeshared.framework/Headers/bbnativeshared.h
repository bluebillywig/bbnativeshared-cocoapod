...
@interface BbnativesharedAutoPlayNextTimer : BbnativesharedBase <BbnativesharedEventListenerInterface, BbnativesharedKotlinx_coroutines_coreCoroutineScope>
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BuildVersion")))
@interface BbnativesharedBuildVersion : BbnativesharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)buildVersion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) BbnativesharedBuildVersion *shared __attribute__((swift_name("shared")));
@property (readonly) NSString *versionTag __attribute__((swift_name("versionTag")));
@end
 ...
 * @suppress
 */
- (BbnativesharedKotlinInstant * _Nullable)tryCreateOfDateTimeStr:(NSString *)str __attribute__((swift_name("tryCreateOfDateTime(str:)")));

/**
 * @param {String} str , e.g. "Sat, 25 May 2024 23:59:00 +0200"
 * @suppress
 */
- (BbnativesharedKotlinInstant * _Nullable)tryCreateOfFullDateTimeStr:(NSString *)str __attribute__((swift_name("tryCreateOfFullDateTime(str:)")));

/**
 * @param {String} str , e.g. "2024-05-25T23:59:00Z"
 * @suppress
 */
- (BbnativesharedKotlinInstant * _Nullable)tryCreateOfIso8601DateTimeStr:(NSString *)str __attribute__((swift_name("tryCreateOfIso8601DateTime(str:)")));
@end
...
@interface BbnativesharedSoftEmbargoTimer : BbnativesharedBase <BbnativesharedKotlinx_coroutines_coreCoroutineScope>
- (instancetype)initWithEventBus:(id<BbnativesharedEventBusInterface> _Nullable)eventBus pc:(BbnativesharedProgramController * _Nullable)pc __attribute__((swift_name("init(eventBus:pc:)"))) __attribute__((objc_designated_initializer));
...
- (void)__destruct __attribute__((swift_name("__destruct()")));
- (void)cancel __attribute__((swift_name("cancel()")));
- (void)startEndDate:(BbnativesharedKotlinInstant *)endDate __attribute__((swift_name("start(endDate:)")));
@property (readonly) id<BbnativesharedKotlinCoroutineContext> coroutineContext __attribute__((swift_name("coroutineContext")));
@end
 ...
 * @suppress
 */
- (void)loadAdServicesDataAdServicesData:(NSArray<BbnativesharedAdUnit *> *)adServicesData initiator:(NSString * _Nullable)initiator autoPlay:(BbnativesharedBoolean * _Nullable)autoPlay seekPosition:(id _Nullable)seekPosition context:(NSDictionary<NSString *, id> * _Nullable)context __attribute__((swift_name("loadAdServicesData(adServicesData:initiator:autoPlay:seekPosition:context:)")));

/**
 * load content data
 * @suppress
 */
- (void)loadContentContent:(id<BbnativesharedContentItemInterface>)content initiator:(NSString * _Nullable)initiator autoPlay:(BbnativesharedBoolean * _Nullable)autoPlay seekPosition:(id _Nullable)seekPosition context:(NSDictionary<NSString *, id> * _Nullable)context listOffset:(BbnativesharedInt * _Nullable)listOffset __attribute__((swift_name("loadContent(content:initiator:autoPlay:seekPosition:context:listOffset:)")));

/**
 * load content
 * @suppress
 */
- (void)loadContentByIdContentId:(NSString *)contentId contentIndicator:(NSString * _Nullable)contentIndicator initiator:(NSString * _Nullable)initiator autoPlay:(BbnativesharedBoolean * _Nullable)autoPlay seekPosition:(id _Nullable)seekPosition context:(NSDictionary<NSString *, id> * _Nullable)context listOffset:(BbnativesharedInt * _Nullable)listOffset __attribute__((swift_name("loadContentById(contentId:contentIndicator:initiator:autoPlay:seekPosition:context:listOffset:)")));
- (void)onEventEventType:(BbnativesharedEventName *)eventType data:(NSDictionary<NSString *, id> * _Nullable)data __attribute__((swift_name("onEvent(eventType:data:)")));
- (void)pause __attribute__((swift_name("pause()")));
...
- (BOOL)clipHasSignAssetAssets:(NSArray<BbnativesharedMediaAsset *> * _Nullable)assets __attribute__((swift_name("clipHasSignAsset(assets:)")));
...
- (BOOL)shouldDropMpdForNonSignShortlist:(NSArray<BbnativesharedMediaAsset *> *)shortlist hasSignAsset:(BOOL)hasSignAsset __attribute__((swift_name("shouldDropMpdForNonSign(shortlist:hasSignAsset:)")));
@property (readonly) NSString *TAG __attribute__((swift_name("TAG")));
@end
...
- (void)__destruct __attribute__((swift_name("__destruct()")));
- (void)getContentFromJsonUrlJsonUrl:(NSString *)jsonUrl onSuccess:(void (^)(id<BbnativesharedContentItemInterface> contentItem))onSuccess onFailure:(void (^)(BbnativesharedKotlinException *error))onFailure __attribute__((swift_name("getContentFromJsonUrl(jsonUrl:onSuccess:onFailure:)")));
- (void)getJsonStringFromUrlJsonUrl:(NSString *)jsonUrl onSuccess:(void (^)(NSString *jsonString))onSuccess onFailure:(void (^)(BbnativesharedKotlinException *error))onFailure __attribute__((swift_name("getJsonStringFromUrl(jsonUrl:onSuccess:onFailure:)")));
- (void)getObjectFromJsonUrlJsonUrl:(NSString *)jsonUrl onSuccess:(void (^)(id _Nullable retObject))onSuccess onFailure:(void (^)(BbnativesharedKotlinException *error))onFailure __attribute__((swift_name("getObjectFromJsonUrl(jsonUrl:onSuccess:onFailure:)")));
@property (readonly) id<BbnativesharedKotlinCoroutineContext> coroutineContext __attribute__((swift_name("coroutineContext")));
@property id<BbnativesharedNetworkInterface> _Nullable network __attribute__((swift_name("network")));
@end
...
- (BbnativesharedPlayout * _Nullable)parsePlayoutJsonString:(NSString *)jsonString __attribute__((swift_name("parsePlayout(jsonString:)")));
...
@property (readonly) BbnativesharedKotlinx_serialization_jsonJson *optimizedJsonParser __attribute__((swift_name("optimizedJsonParser")));
@end
...
@property (class, readonly) BbnativesharedApiMethod *setvolume __attribute__((swift_name("setvolume")));
@property (class, readonly) BbnativesharedApiMethod *setmuted __attribute__((swift_name("setmuted")));
@property (class, readonly) BbnativesharedApiMethod *skipad __attribute__((swift_name("skipad")));
@property (class, readonly) BbnativesharedApiMethod *showinterfaceelement __attribute__((swift_name("showinterfaceelement")));
@property (class, readonly) BbnativesharedApiMethod *hideinterfaceelement __attribute__((swift_name("hideinterfaceelement")));
@property (class, readonly) BbnativesharedApiMethod *enableinterfaceelement __attribute__((swift_name("enableinterfaceelement")));
@property (class, readonly) BbnativesharedApiMethod *disableinterfaceelement __attribute__((swift_name("disableinterfaceelement")));
@property (class, readonly) BbnativesharedApiMethod *doopenurl __attribute__((swift_name("doopenurl")));
@property (class, readonly) BbnativesharedApiMethod *doshare __attribute__((swift_name("doshare")));
@property (class, readonly) BbnativesharedApiMethod *setsubtitle __attribute__((swift_name("setsubtitle")));
@property (class, readonly) BbnativesharedApiMethod *selectaudiotrack __attribute__((swift_name("selectaudiotrack")));
@property (class, readonly) BbnativesharedApiMethod *selectvideotrack __attribute__((swift_name("selectvideotrack")));
@property (class, readonly) BbnativesharedApiMethod *setsignlanguage __attribute__((swift_name("setsignlanguage")));
@property (class, readonly) BbnativesharedApiMethod *enablesignlanguage __attribute__((swift_name("enablesignlanguage")));
@property (class, readonly) BbnativesharedApiMethod *disablesignlanguage __attribute__((swift_name("disablesignlanguage")));
@property (class, readonly) BbnativesharedApiMethod *updateplayout __attribute__((swift_name("updateplayout")));
+ (BbnativesharedKotlinArray<BbnativesharedApiMethod *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<BbnativesharedApiMethod *> *entries __attribute__((swift_name("entries")));
@end
...
@property (class, readonly) BbnativesharedApiProperty *videotracks __attribute__((swift_name("videotracks")));
@property (class, readonly) BbnativesharedApiProperty *currentvideotrack __attribute__((swift_name("currentvideotrack")));
...
@property (class, readonly) BbnativesharedEventName *bbAdsystemSkippable __attribute__((swift_name("bbAdsystemSkippable")));
...
@property (class, readonly) BbnativesharedEventName *videotrackschanged __attribute__((swift_name("videotrackschanged")));
@property (class, readonly) BbnativesharedEventName *subtitletrackchanged __attribute__((swift_name("subtitletrackchanged")));
@property (class, readonly) BbnativesharedEventName *videotrackchanged __attribute__((swift_name("videotrackchanged")));
...
@property (class, readonly) NSArray<BbnativesharedEventName *> *entries __attribute__((swift_name("entries")));
@end
...
@property (class, readonly) NSArray<BbnativesharedFitMode *> *entries __attribute__((swift_name("entries")));
@end
...
@property (class, readonly) NSArray<BbnativesharedPhase *> *entries __attribute__((swift_name("entries")));
@end
...
@property (class, readonly) NSArray<BbnativesharedPosType *> *entries __attribute__((swift_name("entries")));
@end
...
@property (class, readonly) NSArray<BbnativesharedState *> *entries __attribute__((swift_name("entries")));
@end
...
@required
- (void)__destruct __attribute__((swift_name("__destruct()")));
- (void)getJsonStringJsonUrl:(NSString *)jsonUrl onSuccess:(void (^)(NSString *retObject))onSuccess onFailure:(void (^)(BbnativesharedBoolean *error))onFailure __attribute__((swift_name("getJsonString(jsonUrl:onSuccess:onFailure:)")));
- (void)getJsonStringAndHeadersJsonUrl:(NSString *)jsonUrl onSuccess:(void (^)(NSString *retObject, NSDictionary<NSString *, NSArray<NSString *> *> *responseHeaders))onSuccess onFailure:(void (^)(BbnativesharedBoolean *error))onFailure __attribute__((swift_name("getJsonStringAndHeaders(jsonUrl:onSuccess:onFailure:)")));
- (void)logStatsUrl:(NSString *)url onSuccess:(void (^)(void))onSuccess onFailure:(void (^)(BbnativesharedBoolean *error))onFailure __attribute__((swift_name("logStats(url:onSuccess:onFailure:)")));
@end
...
- (instancetype)initWithEventBus:(id<BbnativesharedEventBusInterface> _Nullable)eventBus network:(id<BbnativesharedNetworkInterface> _Nullable)network __attribute__((swift_name("init(eventBus:network:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithEventBus:(id<BbnativesharedEventBusInterface> _Nullable)eventBus network:(id<BbnativesharedNetworkInterface> _Nullable)network ioDispatcher:(BbnativesharedKotlinx_coroutines_coreCoroutineDispatcher *)ioDispatcher __attribute__((swift_name("init(eventBus:network:ioDispatcher:)"))) __attribute__((objc_designated_initializer));
...
@property (readonly) NSString * _Nullable durationBackgroundColor __attribute__((swift_name("durationBackgroundColor")));
@property (readonly) BbnativesharedInt * _Nullable firstAdPosition __attribute__((swift_name("firstAdPosition")));
@property (readonly) NSString * _Nullable id __attribute__((swift_name("id")));
@property (readonly) BbnativesharedInt * _Nullable listThumbnailGap __attribute__((swift_name("listThumbnailGap")));
...
@property (readonly) NSString * _Nullable outlineColor __attribute__((swift_name("outlineColor")));
@property (readonly) BbnativesharedPlayout * _Nullable playout __attribute__((swift_name("playout")));
@property (readonly) BbnativesharedBoolean * _Nullable shelfMovingThumbnail __attribute__((swift_name("shelfMovingThumbnail")));
...
@property (readonly) BbnativesharedBoolean * _Nullable showOutlineForUnwatchedClips __attribute__((swift_name("showOutlineForUnwatchedClips")));
@property (readonly) BbnativesharedBoolean * _Nullable showPlayIconInTimestamp __attribute__((swift_name("showPlayIconInTimestamp")));
 ...
 */
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property NSString * _Nullable bbCpJwtCookieString __attribute__((swift_name("bbCpJwtCookieString")));
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (instancetype)initWithSeen0:(int32_t)seen0 isPrefetch:(BOOL)isPrefetch isPlayed:(BOOL)isPlayed serializationConstructorMarker:(id _Nullable)serializationConstructorMarker __attribute__((swift_name("init(seen0:isPrefetch:isPlayed:serializationConstructorMarker:)"))) __attribute__((objc_designated_initializer));
 ...
 */
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ContextFrame")))
@interface BbnativesharedContextFrame : BbnativesharedBase
- (instancetype)initWithContentList:(NSMutableArray<id<BbnativesharedContentItemInterface>> *)contentList contentListIndex:(int32_t)contentListIndex contextCollectionType:(NSString * _Nullable)contextCollectionType contextCollectionId:(NSString * _Nullable)contextCollectionId contextEntityType:(NSString * _Nullable)contextEntityType contextEntityId:(NSString * _Nullable)contextEntityId contentIndicator:(NSString * _Nullable)contentIndicator contentId:(NSString * _Nullable)contentId clipListId:(NSString * _Nullable)clipListId nestingLevel:(int32_t)nestingLevel __attribute__((swift_name("init(contentList:contentListIndex:contextCollectionType:contextCollectionId:contextEntityType:contextEntityId:contentIndicator:contentId:clipListId:nestingLevel:)"))) __attribute__((objc_designated_initializer));
- (BbnativesharedContextFrame *)doCopyContentList:(NSMutableArray<id<BbnativesharedContentItemInterface>> *)contentList contentListIndex:(int32_t)contentListIndex contextCollectionType:(NSString * _Nullable)contextCollectionType contextCollectionId:(NSString * _Nullable)contextCollectionId contextEntityType:(NSString * _Nullable)contextEntityType contextEntityId:(NSString * _Nullable)contextEntityId contentIndicator:(NSString * _Nullable)contentIndicator contentId:(NSString * _Nullable)contentId clipListId:(NSString * _Nullable)clipListId nestingLevel:(int32_t)nestingLevel __attribute__((swift_name("doCopy(contentList:contentListIndex:contextCollectionType:contextCollectionId:contextEntityType:contextEntityId:contentIndicator:contentId:clipListId:nestingLevel:)")));
...
@property (readonly) NSMutableArray<id<BbnativesharedContentItemInterface>> *contentList __attribute__((swift_name("contentList")));
@property (readonly) int32_t contentListIndex __attribute__((swift_name("contentListIndex")));
@property (readonly) NSString * _Nullable contextCollectionId __attribute__((swift_name("contextCollectionId")));
@property (readonly) NSString * _Nullable contextCollectionType __attribute__((swift_name("contextCollectionType")));
@property (readonly) NSString * _Nullable contextEntityId __attribute__((swift_name("contextEntityId")));
@property (readonly) NSString * _Nullable contextEntityType __attribute__((swift_name("contextEntityType")));
@property (readonly) int32_t nestingLevel __attribute__((swift_name("nestingLevel")));
@end
...
- (instancetype)initWithMediatype:(NSString * _Nullable)mediatype id:(NSString * _Nullable)id status:(NSString * _Nullable)status src:(NSString * _Nullable)src length:(NSString * _Nullable)length exactlength:(NSString * _Nullable)exactlength width:(NSString * _Nullable)width height:(NSString * _Nullable)height bandwidth:(NSString * _Nullable)bandwidth jobdefid:(NSString * _Nullable)jobdefid languageId:(NSString * _Nullable)languageId languageName:(NSString * _Nullable)languageName languageIsocode:(NSString * _Nullable)languageIsocode isDefaultLanguage:(BbnativesharedBoolean * _Nullable)isDefaultLanguage title:(NSString * _Nullable)title role:(NSString * _Nullable)role isocode:(NSString * _Nullable)isocode __attribute__((swift_name("init(mediatype:id:status:src:length:exactlength:width:height:bandwidth:jobdefid:languageId:languageName:languageIsocode:isDefaultLanguage:title:role:isocode:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) BbnativesharedMediaAssetCompanion *companion __attribute__((swift_name("companion")));
- (BbnativesharedMediaAsset *)doCopyMediatype:(NSString * _Nullable)mediatype id:(NSString * _Nullable)id status:(NSString * _Nullable)status src:(NSString * _Nullable)src length:(NSString * _Nullable)length exactlength:(NSString * _Nullable)exactlength width:(NSString * _Nullable)width height:(NSString * _Nullable)height bandwidth:(NSString * _Nullable)bandwidth jobdefid:(NSString * _Nullable)jobdefid languageId:(NSString * _Nullable)languageId languageName:(NSString * _Nullable)languageName languageIsocode:(NSString * _Nullable)languageIsocode isDefaultLanguage:(BbnativesharedBoolean * _Nullable)isDefaultLanguage title:(NSString * _Nullable)title role:(NSString * _Nullable)role isocode:(NSString * _Nullable)isocode __attribute__((swift_name("doCopy(mediatype:id:status:src:length:exactlength:width:height:bandwidth:jobdefid:languageId:languageName:languageIsocode:isDefaultLanguage:title:role:isocode:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) NSArray<NSString *> * _Nullable cpRuleViolations __attribute__((swift_name("cpRuleViolations")));
@property (readonly) NSString * _Nullable cpp __attribute__((swift_name("cpp")));
@property (readonly) NSString * _Nullable createddate __attribute__((swift_name("createddate")));
...
@property (readonly) NSString * _Nullable publisheddate __attribute__((swift_name("publisheddate")));
@property (readonly) NSString * _Nullable relatedItemsListId __attribute__((swift_name("relatedItemsListId")));
...
- (instancetype)initWithId:(NSString * _Nullable)id title:(NSString * _Nullable)title deeplink:(NSString * _Nullable)deeplink numfound:(BbnativesharedLong * _Nullable)numfound offset:(BbnativesharedLong * _Nullable)offset parentid:(NSString * _Nullable)parentid status:(NSString * _Nullable)status publication:(NSArray<NSString *> * _Nullable)publication parentpublicationid:(NSString * _Nullable)parentpublicationid mediatype:(NSString * _Nullable)mediatype usetype:(NSString * _Nullable)usetype modifieddate:(NSString * _Nullable)modifieddate createddate:(NSString * _Nullable)createddate publishedDate:(NSString * _Nullable)publishedDate listtypeString:(NSString * _Nullable)listtypeString isEmptyBoolean:(BbnativesharedBoolean * _Nullable)isEmptyBoolean filtersString:(NSString * _Nullable)filtersString createdbyString:(NSString * _Nullable)createdbyString updatedbyString:(NSString * _Nullable)updatedbyString allowDatasource:(NSString * _Nullable)allowDatasource allowDatasource_boolean:(BbnativesharedBoolean * _Nullable)allowDatasource_boolean cpRuleViolations:(NSArray<NSString *> * _Nullable)cpRuleViolations cpp:(NSString * _Nullable)cpp score:(BbnativesharedDouble * _Nullable)score count:(BbnativesharedLong * _Nullable)count items:(NSArray<BbnativesharedContentItem *> * _Nullable)items __attribute__((swift_name("init(id:title:deeplink:numfound:offset:parentid:status:publication:parentpublicationid:mediatype:usetype:modifieddate:createddate:publishedDate:listtypeString:isEmptyBoolean:filtersString:createdbyString:updatedbyString:allowDatasource:allowDatasource_boolean:cpRuleViolations:cpp:score:count:items:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (instancetype)initWithSeen0:(int32_t)seen0 isPrefetch:(BOOL)isPrefetch isPlayed:(BOOL)isPlayed serializationConstructorMarker:(id _Nullable)serializationConstructorMarker __attribute__((swift_name("init(seen0:isPrefetch:isPlayed:serializationConstructorMarker:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
...
@property (readonly) NSString * _Nullable audioDescriptionButton __attribute__((swift_name("audioDescriptionButton")));
...
@property (readonly) NSString * _Nullable createddate __attribute__((swift_name("createddate")));
@property (readonly) NSString * _Nullable ctaBackgroundColor __attribute__((swift_name("ctaBackgroundColor")));
@property (readonly) NSString * _Nullable ctaButtonLabelField __attribute__((swift_name("ctaButtonLabelField")));
...
@property (readonly) NSString * _Nullable enableSubtitlesByDefault __attribute__((swift_name("enableSubtitlesByDefault")));
...
@property (readonly) NSString * _Nullable signLanguageButton __attribute__((swift_name("signLanguageButton")));
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) BbnativesharedKotlinInstantCompanion *shared __attribute__((swift_name("shared")));
- (BbnativesharedKotlinInstant *)fromEpochMillisecondsEpochMilliseconds:(int64_t)epochMilliseconds __attribute__((swift_name("fromEpochMilliseconds(epochMilliseconds:)")));
- (BbnativesharedKotlinInstant *)fromEpochSecondsEpochSeconds:(int64_t)epochSeconds nanosecondAdjustment:(int32_t)nanosecondAdjustment __attribute__((swift_name("fromEpochSeconds(epochSeconds:nanosecondAdjustment:)")));
- (BbnativesharedKotlinInstant *)fromEpochSecondsEpochSeconds:(int64_t)epochSeconds nanosecondAdjustment_:(int64_t)nanosecondAdjustment __attribute__((swift_name("fromEpochSeconds(epochSeconds:nanosecondAdjustment_:)")));
- (BbnativesharedKotlinInstant *)now __attribute__((swift_name("now()"))) __attribute__((unavailable("Use Clock.System.now() instead")));
- (BbnativesharedKotlinInstant *)parseInput:(id)input __attribute__((swift_name("parse(input:)")));
- (BbnativesharedKotlinInstant * _Nullable)parseOrNullInput:(id)input __attribute__((swift_name("parseOrNull(input:)")));
@property (readonly) BbnativesharedKotlinInstant *DISTANT_FUTURE __attribute__((swift_name("DISTANT_FUTURE")));
@property (readonly) BbnativesharedKotlinInstant *DISTANT_PAST __attribute__((swift_name("DISTANT_PAST")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Kotlinx_serialization_jsonJson.Default")))
@interface BbnativesharedKotlinx_serialization_jsonJsonDefault : BbnativesharedKotlinx_serialization_jsonJson
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)default_ __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) BbnativesharedKotlinx_serialization_jsonJsonDefault *shared __attribute__((swift_name("shared")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Kotlinx_serialization_jsonJsonConfiguration")))
@interface BbnativesharedKotlinx_serialization_jsonJsonConfiguration : BbnativesharedBase
- (NSString *)description __attribute__((swift_name("description()")));
 ...
 *   kotlinx.serialization.ExperimentalSerializationApi
*/
@property BbnativesharedKotlinx_serialization_jsonClassDiscriminatorMode *classDiscriminatorMode __attribute__((swift_name("classDiscriminatorMode")));
 ...
 *   kotlinx.serialization.ExperimentalSerializationApi
*/
@property (readonly) id<BbnativesharedKotlinx_serialization_jsonJsonNamingStrategy> _Nullable namingStrategy __attribute__((swift_name("namingStrategy")));
...
@required
- (void)contextualKClass:(id<BbnativesharedKotlinKClass>)kClass provider:(id<BbnativesharedKotlinx_serialization_coreKSerializer> (^)(NSArray<id<BbnativesharedKotlinx_serialization_coreKSerializer>> *typeArgumentsSerializers))provider __attribute__((swift_name("contextual(kClass:provider:)")));
...
@interface BbnativesharedKotlinx_serialization_jsonClassDiscriminatorMode : BbnativesharedKotlinEnum<BbnativesharedKotlinx_serialization_jsonClassDiscriminatorMode *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) BbnativesharedKotlinx_serialization_jsonClassDiscriminatorMode *none __attribute__((swift_name("none")));
@property (class, readonly) BbnativesharedKotlinx_serialization_jsonClassDiscriminatorMode *allJsonObjects __attribute__((swift_name("allJsonObjects")));
@property (class, readonly) BbnativesharedKotlinx_serialization_jsonClassDiscriminatorMode *polymorphic __attribute__((swift_name("polymorphic")));
+ (BbnativesharedKotlinArray<BbnativesharedKotlinx_serialization_jsonClassDiscriminatorMode *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<BbnativesharedKotlinx_serialization_jsonClassDiscriminatorMode *> *entries __attribute__((swift_name("entries")));
@end
...
@protocol BbnativesharedKotlinx_serialization_jsonJsonNamingStrategy
@required
- (NSString *)serialNameForJsonDescriptor:(id<BbnativesharedKotlinx_serialization_coreSerialDescriptor>)descriptor elementIndex:(int32_t)elementIndex serialName:(NSString *)serialName __attribute__((swift_name("serialNameForJson(descriptor:elementIndex:serialName:)")));
@end
