...
@property (readonly) BbnativesharedPlayout * _Nullable playout __attribute__((swift_name("playout")));
@property (readonly) BbnativesharedBoolean * _Nullable shelfFirstItemMovingThumb __attribute__((swift_name("shelfFirstItemMovingThumb")));
