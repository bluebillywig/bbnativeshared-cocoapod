...
- (NSArray<BbnativesharedEventHandler *> * _Nullable)component95 __attribute__((swift_name("component95()")));
...
- (BbnativesharedFitMode * _Nullable)component121 __attribute__((swift_name("component121()")));
...
- (NSArray<BbnativesharedKotlinx_serialization_jsonJsonElement *> * _Nullable)component166 __attribute__((swift_name("component166()")));
- (BbnativesharedBoolean * _Nullable)component167 __attribute__((swift_name("component167()")));
- (NSArray<BbnativesharedAdUnit *> * _Nullable)component168 __attribute__((swift_name("component168()")));
